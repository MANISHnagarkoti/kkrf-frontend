...
const Talk = () => {
    ...
    return (
        <div className="py-20 bg-colorTwo mt-24">
            ...
            <div
                className={`fixed top-0 bg-black/70 w-full h-screen left-0 hidden justify-center items-center pointer-events-none opacity-0 transition-all duration-150 p-6 backdrop-blur-md z-50 ${pop && `!flex opacity-100 pointer-events-auto`
                    }`}
            >
                <div className="w-full md:w-[70%] bg-white rounded-2xl p-6 md:p-12">
                    <div className="flex justify-between">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 cursor-pointer hover:text-gray-500" onClick={()=> setPop(false)}>
                            <path fillRule="evenodd" d="M5.47 5.47a.75.75 0 0 1 1.06 0L12 10.94l5.47-5.47a.75.75 0 1 1 1.06 1.06L13.06 12l5.47 5.47a.75.75 0 1 1-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 0 1-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
                        </svg>
                    </div>
                    <div className="flex gap-6 mt-6">
                        <div className="w-full xl:w-[40%] space-y-6 dark-shadow p-9 rounded-md">
                            <div>
                        ...
                        <div className="w-[60%] p-9 hidden xl:block">
                            ...
                            <div className="mt-9 space-y-6">
                                ...
                                <div className="flex justify-between border-b border-gray-400 pb-4">
                                    <div>
                                        <div className="text-base font-semibold">Ask your queries</div>
                                        <div className="mt-4 text-gray-500">
