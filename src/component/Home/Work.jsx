      ...
      <div className="grid xl:grid-cols-2 gap-24 mt-9">
        <div className="space-y-2">
            ...
            >
              ...
              <div
                className={`text-sm  mt-0  opacity-0  text-gray-700 transition-all duration-300 overflow-hidden h-0 ${
                  active === "corporate" && `mt-6 opacity-100 h-24`
                }`}
              >
                At KKRF Groups we are specialize in idea-based website designing
                that help you stand out from the competition. Our team of
                creative designers and developers collaborate with you to
                understand your unique vision and business needs and create a
                customized website that
              </div>
            </div>
          </Link>
          ...
          >
            ...
            >
              At KKRF Groups we are specialize in idea-based website designing
              that help you stand out from the competition. Our team of creative
              designers and developers collaborate with you to understand your
              unique vision and business needs and create a customized website
              that
            </div>
          </div>
          </Link>
